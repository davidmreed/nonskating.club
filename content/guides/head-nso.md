...
The Head Non-Skating Official role is a broad and deep leadership position, and can be responsible for different scopes in different contexts. There's no one right way to be the HNSO. This guide aims to cover how the role is performed in single games, tournaments, and at the league level, while acknowledging that the boundaries between this role and others are not the same everywhere.
