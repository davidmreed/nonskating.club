...
Due to the complexity of Jammer swaps, Penalty Box Timers will handle the paperwork when a Jammer enters the box but the Penalty Box Manager will be responsible for running their timer so they can be prepared to handle an unexpected swap.
